...
<center><sub>These requirements are based on running a desktop environment, not a minimal install.</sub></center>
<center><h2>Default Software:</h2></center>
<ul>
...
<center><sub>Used to the commands of <code>vim</code> and <code>nano?</code> Don't worry, those commands route to the new editors, meaning your workflow should not be disrupted.</sub></center>
<center><h2>Features:</h2></center>
<ul>
<li><strong>zsh:</strong> A powerful, feature-rich shell that is designed to be a drop-in replacement for Bash. Powered by OMZ, you get autosuggestions, syntax highlighting, and more.</li>
